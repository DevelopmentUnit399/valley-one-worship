...
const MusicResourcesHome = ({ LATEST_ALBUM, RECENT_SONGS }) => {
    return (
        <section data-theme="dark" className="bg-[#212121] text-white py-20 px-6 sm:px-12 w-full">
            <div className="row mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12">
                ...
                <div className="w-full lg:w-1/4 flex flex-col items-center lg:items-start justify-center text-center lg:text-left">
                    ...
                    <Link
                        to="/music"
                        className="inline-flex items-center gap-2 border border-neutral-300 bg-neutral-300 text-[#212121] rounded-full px-6 py-2.5 text-sm font-semibold tracking-wide transition-colors duration-200 hover:bg-white hover:border-white"
                    >
