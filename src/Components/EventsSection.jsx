...
export default function EventsSection() {
  ...
  return (
    <section className="bg-white text-neutral-900 py-20 px-6 sm:px-12 w-full border-t border-neutral-200">
      <div className="max-w-5xl mx-auto flex flex-col items-center">
        
        {/* Section Header */}
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-black tracking-wider uppercase mb-3 text-neutral-900">
            Events &amp; On The Road
          </h2>
        ...
        {!loading && events.length === 0 && (
          <div className="w-full bg-neutral-50 border border-neutral-200 rounded-3xl p-10 sm:p-14 flex flex-col items-center text-center max-w-2xl shadow-sm">
            <div className="w-12 h-12 rounded-full bg-neutral-200/60 flex items-center justify-center mb-4 text-neutral-600">
          ...
          <div className="w-full flex flex-col divide-y divide-neutral-200 border-y border-neutral-200">
            {events.map((event) => {
              ...
              return (
                <div
                  key={event.id}
                  className="py-6 px-4 sm:px-6 flex flex-col md:flex-row md:items-center justify-between gap-6 transition-colors duration-200 hover:bg-neutral-50/70 rounded-2xl"
                >
                  {/* Left: Date Badge */}
                  ...
                  <div className="flex-1 flex flex-col text-left">
                    {/* Event / Tour Title */}
                    <h3 className="text-lg sm:text-xl font-bold text-neutral-900 tracking-tight leading-snug line-clamp-1">
                      {eventTitle}
                    </h3>

                    {/* Venue & Location pin */}
                    <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mt-1 text-sm text-neutral-600">
                      <span className="font-semibold text-neutral-800">{event.venue.name}</span>
                  ...
                  <div className="flex items-center gap-3 shrink-0 self-start md:self-center">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 bg-black text-white px-5 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wider transition-colors duration-200 hover:bg-neutral-800"
                    >
                      <span>Tickets</span>
